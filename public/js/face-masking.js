...
function initFaceMasking() {

    var webcam			= $("#local-video-container video")[0];		// our webcam video
    console.log(webcam);
    ...
    function startCamera() {
        ...
        window.navigator.mediaDevices.getUserMedia({video: {width: 800, height: 600, frameRate: 30}})
